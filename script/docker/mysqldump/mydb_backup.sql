...
CREATE TABLE `access_logs` (
  ...
  `request_url` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `ai_chats` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_ai_chats_agent` (`agent_id`),
  KEY `idx_ai_chats_status` (`status`),
...
CREATE TABLE `certificates` (
  ...
  `certificate_type` enum('BRONZE','SILVER','GOLD','PLATINUM','DIAMOND') COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
...
--
-- Table structure for table `drawing_participants`
--
...
--
-- Dumping data for table `drawing_participants`
--

LOCK TABLES `drawing_participants` WRITE;
/*!40000 ALTER TABLE `drawing_participants` DISABLE KEYS */;
/*!40000 ALTER TABLE `drawing_participants` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `error_logs` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` bigint DEFAULT NULL,
  `error_level` enum('DEBUG','INFO','WARNING','ERROR','CRITICAL') COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `journal_views`
--
...
--
-- Dumping data for table `journal_views`
--

LOCK TABLES `journal_views` WRITE;
/*!40000 ALTER TABLE `journal_views` DISABLE KEYS */;
/*!40000 ALTER TABLE `journal_views` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `random_drawings`
--
...
CREATE TABLE `random_drawings` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `drawing_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `drawing_type` enum('SWEEPSTAKES','RAFFLE','CONTEST') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `week_number` int NOT NULL,
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_drawing_type` (`drawing_type`),
  KEY `idx_week_number` (`week_number`),
  KEY `idx_drawing_date` (`drawing_date`),
  KEY `idx_status` (`status`),
  KEY `idx_created_by` (`created_by`),
...
--
-- Dumping data for table `random_drawings`
--

LOCK TABLES `random_drawings` WRITE;
/*!40000 ALTER TABLE `random_drawings` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `random_drawings` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `referral_relationships` (
  ...
  KEY `idx_referral_level` (`referral_level`),
  KEY `idx_status` (`status`),
...
CREATE TABLE `transactions` (
  ...
  `transaction_type` enum('WINNING','DEPOSIT','WITHDRAWAL','PURCHASE','REFUND','REWARD','COMMISSION') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `usdt_wallets`
--
...
CREATE TABLE `usdt_wallets` (
  ...
  `wallet_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT 'Main Wallet',
  `wallet_type` enum('COMPANY','MEMBER','TESTING','MAIN','TRADING','STAKING','REWARDS') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'COMPANY',
  ...
  UNIQUE KEY `uk_wallets_wallet_address` (`wallet_address`),
  KEY `idx_user_id` (`user_id`),
...
--
-- Dumping data for table `usdt_wallets`
--

LOCK TABLES `usdt_wallets` WRITE;
/*!40000 ALTER TABLE `usdt_wallets` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `usdt_wallets` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `users` (
  ...
  `role` enum('SUBSCRIBER','ADMIN','SUPER_ADMIN') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'SUBSCRIBER',
  `status` enum('ACTIVE','INACTIVE','SUSPENDED') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ACTIVE',
  `referral_code` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `referred_by_code` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'COMPANY001',
  `join_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `last_login` timestamp NULL DEFAULT NULL,
  `email_verified_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `level` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'CHIEF',
  PRIMARY KEY (`id`),
...
CREATE TABLE `wallet_payments` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_wallet_payments_wallet` (`to_wallet_id`),
...
-- Dump completed on 2025-09-18  6:09:23
